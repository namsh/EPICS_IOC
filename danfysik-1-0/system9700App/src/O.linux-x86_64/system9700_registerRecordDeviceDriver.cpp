...
/* Generated from ../O.Common/system9700.dbd */
...
int system9700_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/EPICS_IOC/danfysik-1-0";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"system9700_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    system9700_registerRecordDeviceDriver(*iocshPpdbbase);
}
