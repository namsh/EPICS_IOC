...
/* Generated from ../O.Common/vgc3501.dbd */
...
int vgc3501_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/KoreaUniv/mks-1-0";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vgc3501_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vgc3501_registerRecordDeviceDriver(*iocshPpdbbase);
}
