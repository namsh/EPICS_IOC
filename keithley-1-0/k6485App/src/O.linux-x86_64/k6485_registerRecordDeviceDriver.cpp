...
/* Generated from ../O.Common/k6485.dbd */
...
int k6485_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/KoreaUniv/keithley-1-0";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"k6485_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    k6485_registerRecordDeviceDriver(*iocshPpdbbase);
}
