...
/* Generated from ../O.Common/DigitalInterface.dbd */
...
int DigitalInterface_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/EPICS_IOC/heinzinger-1-0";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"DigitalInterface_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    DigitalInterface_registerRecordDeviceDriver(*iocshPpdbbase);
}
