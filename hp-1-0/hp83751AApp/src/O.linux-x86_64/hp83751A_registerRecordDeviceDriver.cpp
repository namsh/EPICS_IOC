...
/* Generated from ../O.Common/hp83751A.dbd */
...
epicsShareExtern void (*pvar_func_GpibBoardDriverRegister)(void);
...
int hp83751A_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/EPICS_IOC/hp-1-0";
    ...
    (*pvar_func_GpibBoardDriverRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"hp83751A_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    hp83751A_registerRecordDeviceDriver(*iocshPpdbbase);
}
