...
/* Generated from ../O.Common/E4419B.dbd */
...
int E4419B_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/namsh/epics/R3.14.12.5/KoreaUniv/hp-1-0";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"E4419B_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    E4419B_registerRecordDeviceDriver(*iocshPpdbbase);
}
